...
- 2026-09-17 몸통·피격 분리 승인: 원형 기준 지름은 표시 스프라이트의 짧은 변이며 몸통 80%, 몬스터 피격 영역 110%를 사용한다. BodyRadius는 지형·접촉, HurtRadius는 무기 적중에 사용하고 VisualFootOffset은 기존 발 위치를 유지한다. 지상끼리 반복 밀어내기를 없애고 이동 중 약한 방향 회피만 수행한다. 공격 피격 넉백과 지형 통과 금지는 유지한다. 1,000마리는 명시적 진단 조건이며 실제 일반 상한 500을 자동으로 올리지 않는다.
