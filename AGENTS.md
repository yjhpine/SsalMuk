...
- A1~A5, B1~B4, C1~C3 경험치·성장·선택·무기 4종 전투를 구현·검증했다. 사용자가 B·C·D 전체 진행을 승인했다. 다음은 D1 지속 출현·공중 무리·보스 중첩부터 순차 진행하며 재승인을 반복하지 않는다. 진행 중 계정 사용량이 10% 이하로 남으면 사용자에게 알린다.
