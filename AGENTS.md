...
- A1~A5, B1 플레이어 AI/FSM, B2 피해·접촉·넉백·드롭 모델을 구현·검증했다. 사용자가 B·C·D 전체 진행을 승인했다. 다음은 B3 검 자동 전투와 통합 실행부터 순차 진행하며 재승인을 반복하지 않는다. 진행 중 계정 사용량이 10% 이하로 남으면 사용자에게 알린다.
