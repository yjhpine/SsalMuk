...
파이어볼은 첫 적에게 명중한 위치에서 폭발하고 투사체가 사라진다. 적을 관통하지 않으며, 폭발 범위 안의 적들에게 피해를 준다. 2026-09-18 승인으로 빗나간 투사체는 화면 밖 여유 거리 2+투사체 반경을 지나면 폭발 없이 소멸하며 최대 수명 3초도 유지한다. 경계 이후의 먼 적에게는 해당 투사체가 명중하지 않는다. 무기 강화·발사 개수에는 임의 상한을 추가하지 않는다.
...
| 무기 개수 증가 | 단계마다 좌우 15도씩 더 벌어진 무기를 하나씩 추가. 0, ±15, ±30, ±45도 순이며 수는 1+2n |
