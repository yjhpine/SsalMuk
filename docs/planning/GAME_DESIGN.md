...
- 작성일: 2026-09-16
- 상태: 최종 기획·구조 설계 승인 완료 · A1~A5 기반·맵·군집 이동·런타임 표시 구현 · 다음은 B1 플레이어 AI/FSM
...
승인된 A5까지 기반·맵·길찾기·군집 이동과 런타임 메뉴·월드 표시를 구현했다. 현재 화면은 임시 그래픽을 사용하는 이동 미리보기이며 플레이어 자동 운영·피해·무기 공격·성장은 후속 단계다. 다음 작업과 최신 검증은 [인계 문서](../development/HANDOFF.md)를 따른다. 핵심 기획은 유지하며 세부 밸런스 수치는 해당 기능 구현 후 조정한다.
