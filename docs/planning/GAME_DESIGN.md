...
- 작성일: 2026-09-16
- 상태: 기획 정리 완료 · 구조 설계 전 검토본
- 작업 프로젝트: `C:\Users\ace21\Desktop\SsalMuk`
- 진행 순서: 게임 기획 정리 → 구조 설계 → Unity 연결 및 개발·수정·검증

이 문서는 게임의 동작과 플레이 경험을 정한다. 디자인 패턴, 아키텍처, 구체적인 FSM 상태 목록, 길찾기 알고리즘, 코드 구조는 이후 구조 설계에서 선택한다. **게임 규칙**, **구조 설계에서 구체화할 항목**, **나중에 조정할 수치**를 구분한다. 개발 하네스의 세부 규칙은 12절의 초안을 바탕으로 구조 설계에서 정리한다.
