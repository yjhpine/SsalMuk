...
- 작성일: 2026-09-16
- 상태: A1~A5·B1과 B2 피해·넉백·드롭 모델 검증 완료 · B·C·D 전체 실행 승인 · 다음은 B3 검 전투 통합
...
기반·맵·길찾기·군집 이동에 이어 B1~B4의 low AI 자동 운영·검 전투·피해·HUD·사망 결과·재시작을 구현했다. 현재 유닛 표시는 임시 그래픽이며 경험치 흡수·성장 선택·나머지 무기와 최종 아트는 승인된 C·D 단계에서 이어간다. 다음 작업과 최신 검증은 [인계 문서](../development/HANDOFF.md)를 따른다. 핵심 기획은 유지하며 세부 밸런스 수치는 해당 기능 구현 후 조정한다.
