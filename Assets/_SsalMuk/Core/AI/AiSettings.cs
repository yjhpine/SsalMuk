...
namespace SsalMuk.Core
{
    public sealed class AiSettings
    {
        ...
        public double PickupApproachRadius { get; }
        ...
        public AiSettings(double searchDistance = 12, double emergencyContactSeconds = 0.35, int directionCount = 16,
            ...
            double riskWeight = 2, double distanceWeight = 1, double pickupApproachRadius = 0.9)
        {
            foreach (double value in new[] { searchDistance, emergencyContactSeconds, probeDistance, minimumHoldSeconds,
                releaseStableSeconds, noProgressSeconds, riskWeight, distanceWeight, pickupApproachRadius })
            ...
            RiskWeight = riskWeight; DistanceWeight = distanceWeight; PickupApproachRadius = pickupApproachRadius;
        }
    }
}
