...
namespace SsalMuk.Core
{
    public sealed class SpawnSettings
    {
        ...
        public SpawnSettings(double normalBaseRate = 1, double normalRateGrowth = 1.0 / 120, double airInterval = 20,
            ...
            double groundBand = 5, int positionAttempts = 32, int creationBudget = 64)
        {
            foreach (double value in new[] { normalBaseRate, airInterval, airCountGrowthSeconds, airSpacing, groundMargin, groundBand })
